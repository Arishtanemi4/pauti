...
// The full v2 schema (docs/plan/EXECUTE.md §4.3), applied as the first migration. Keep this
// in sync with ../schema.sql, which is the human-readable reference copy of the same DDL —
// schema.sql.test.ts asserts the two never drift apart.
